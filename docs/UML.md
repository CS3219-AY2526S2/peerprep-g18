...
**Goal:** A high-level component diagram showing Front End + each microservice boundary and major dependencies. This represents the final architecture of the PeerPrep system.

![Architecture Diagram](images/PeerPrep%20G18_Architecture%20Diagram.png)
...
![API Gateway Sequence Diagram](images/api-gateway_Sequence%20Diagram.png)
...
![User Service Sequence Diagram](images/user-service_Sequence%20Diagram.png)
...
![Question Service Sequence Diagram](images/question-service_Sequence%20Diagram.png)

### 2.2.4 History Service Sequence Diagram
Sequence diagram showing how the History Service saves session records, fetching consistent question metadata from the Question Service and updating user analytics in Firestore.

**Source:** [`plantUML/history-service-sequence.puml`](plantUML/history-service-sequence.puml)

![History Service Sequence Diagram](images/history-service_Sequence%20Diagram.png)

---

## 2.3 Key user workflows

### 2.3.1 Collaboration flow — ticket acquisition and WebSocket connection
...
![Collaboration Service Sequence Diagram](images/collaboration-service_Sequence%20Diagram.png)
...
### 2.3.2 Match to collaboration — end-to-end flow
...
![Match to Collaboration Sequence Diagram](images/MatchToCollab_Sequence%20Diagram.png)
...
### 2.3.3 Collaboration to History — session end & cleanup
...
- 2026-04-15: Updated `UML.md` with actual diagram images for all services and workflows.
- 2026-04-15: Removed surface-level workflow, promoted Architecture Diagram to final, and added AWS Deployment Diagram section.
- 2026-04-15: Corrected History Service diagram categorization and noted that the full Collaboration to History flow (collabToHistory.puml) is documented as a workflow.
